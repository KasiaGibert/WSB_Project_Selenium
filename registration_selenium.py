...
last_name_field.send_keys('Owerko')
phone_number_field = driver.find_element('id', 'registerPhone')
phone_number_field.send_keys('723922681')
email_field = driver.find_element('id', 'registerEmail')
email_field.send_keys('kasia.gibert@gmail.com')
...
checkbox = driver.find_element('id', 'registerAgree').click()
